...
public class AppHotel001 {
    ...
    public static void main(String[] args) {        
        ...
        CiancaInn=new Hotel();
        do{
            System.out.println("Mennu Principal");
    ...
    public static void AgregarHabitacion(Hotel h){
        int NumCamas, IDHabitacion, tipoHabitacion;
        
        System.out.println("Selecciona el tipo de habitacion: \t1.- Habitacion Suite \t2.- Habitacion Residente \t3.- Habitacion Grupal");
        tipoHabitacion = Opcion();
